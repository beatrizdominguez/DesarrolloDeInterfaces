Module layout
    ...
    Public Sub kidsLayout()
        ...
        Calculadora.KidsToolStripMenuItem.BackColor = Color.GhostWhite
        ...
        'botones
        Calculadora.Btn1.BackColor = Color.SpringGreen
        Calculadora.Btn2.BackColor = Color.DeepSkyBlue
        Calculadora.Btn3.BackColor = Color.SpringGreen
        Calculadora.Btn4.BackColor = Color.DeepSkyBlue
        Calculadora.Btn5.BackColor = Color.SpringGreen
        Calculadora.Btn6.BackColor = Color.DeepSkyBlue
        Calculadora.Btn7.BackColor = Color.SpringGreen
        Calculadora.Btn8.BackColor = Color.DeepSkyBlue
        Calculadora.Btn9.BackColor = Color.SpringGreen
        Calculadora.Btn0.BackColor = Color.SpringGreen
    ...
    Public Sub oldLayout()
        ...
        Calculadora.KidsToolStripMenuItem.BackColor = Color.Empty
        Calculadora.EmpresaToolStripMenuItem.BackColor = Color.Empty
        Calculadora.OldToolStripMenuItem.BackColor = Color.GhostWhite
    ...
    Public Sub businessLayout()
        ...
        'mostrar en que menú contextual te encuentras
        Calculadora.KidsToolStripMenuItem.BackColor = Color.Empty
        Calculadora.EmpresaToolStripMenuItem.BackColor = Color.GhostWhite
        Calculadora.OldToolStripMenuItem.BackColor = Color.Empty
