...
#Region "Tabla de tiempos"
    ...
    Public Sub añadirPartida()
        ...
        If Juego.NumerosMnu.Checked = True Then
            ...
            tiempos.ListBox1.Items.Add(CStr(Juego.lblTime.Text) + cinco + "Numeros    " + CStr(Juego.errores) + cinco + Date.Now.ToString("g") + cinco + nombreJugador())
        ...
        ElseIf Juego.ColoresMnu.Checked = True Then
            ...
            tiempos.ListBox1.Items.Add(CStr(Juego.lblTime.Text) + cinco + "Colores/ " + color + cinco + CStr(Juego.errores) + cinco + Date.Now.ToString("g") + cinco + nombreJugador())
        ...
        ElseIf Juego.SimbolosMnu.Checked = True Then
            ...
            tiempos.ListBox1.Items.Add(CStr(Juego.lblTime.Text) + cinco + "Símbolos/ " + tipo + cinco + CStr(Juego.errores) + cinco + Date.Now.ToString("g") + cinco + nombreJugador())

        End If

        'guardamos la última partida en el archivo
        '?? no es la última fila
        'guardar todo o sólo la última línea
        'si guardamos todo, el mismo problema de ahora
        'si guardamos solo la última no estará ordenado en el archivo
