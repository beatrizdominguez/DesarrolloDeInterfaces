...
#Region "Botones"
    ...
    Public Sub colores(ByVal paleta As String)
        ...
        'boton1
        Juego.btnRef.Visible = True
        Juego.btnRef.Text = ""
        Juego.btnRef.BackColor = colores((Int(25 * Rnd() + 1) - 1))
    ...
    Public Sub simbolos(ByVal grupo As String)
        ...
        ''
        Juego.btnRef.Visible = True
        Juego.btnRef.BackColor = Color.White
        'tipo de letra
        If grupo = "global" Then
            Juego.btnRef.Font = myFont1
        Else
            Juego.btnRef.Font = myFont2
        End If
        'simbolo
        Juego.btnRef.Text = iconos((Int(25 * Rnd() + 1) - 1))
...
#Region "Tabla de tiempos"
    ...
    Public Sub cargarTiempos()
        ...
        'FileOpen(1, "historialPartidas", OpenMode.Append)
    ...
    Public Sub guardarTiempos()
        ...
        'W = New System.IO.StreamWriter(My.Resources.nuevo)
